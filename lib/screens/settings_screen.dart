    ...
    return StreamBuilder<QuerySnapshot>(
      stream: firebaseFirestore
        ...
        builder: (BuildContext context, AsyncSnapshot<QuerySnapshot> snapshot) {
          ...
          sleepTime =
              TimeOfDay.fromDateTime(format.parse(snapshot.data!.docs.first.get('sleeptime')));
          id = snapshot.data!.docs.first.id;
          wakeTime = TimeOfDay.fromDateTime(format.parse(snapshot.data!.docs.first.get('waketime')));
          wakeTimeController.text = wakeTime.format(context).toString();
          sleepTimeController.text = sleepTime.format(context).toString();
          weightController.text = snapshot.data!.docs.first.get("weight").toString();
        return Scaffold(
